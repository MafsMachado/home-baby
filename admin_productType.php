...
$pageTitle = 'Admin - Product Type';
include 'header.php';
?>

<section id="adminProductType" class="pt-5 pb-5">
    ...
    <div class="container">
        ...
        <div class="col-6 text-right">
            ...
            <div class="col-6 text-right">
                <a href="admin_productType_new.php"><button>New Product Type</button></a>
            </div>
        </div>
    </div>
    <table class="mt-4 mr-5">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a class="ml-3" href="admin_productType_edit.php?ID=<?= $row['ID']; ?>">
                    ...
                    <a class="ml-3" href="inc/actions.php?act=deleteProductType&ID=<?= $row['ID']; ?>">
