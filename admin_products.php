...
<section id="adminProducts" class="pt-5 pb-5">
    ...
    <div class="container">
        ...
        <div class="col-6 text-right">
            ...
            <div class="col-6 text-right">
                <a href="admin_products_new.php"><button>New Product</button></a>
            </div>
        </div>
    </div>
    <table class="mt-4 mr-5">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a class="ml-3" href="admin_products_edit.php?ID=<?= $row['ID']; ?>">
                    ...
                    <a class="ml-3" href="inc/actions.php?act=deleteProduct&ID=<?= $row['ID']; ?>">
