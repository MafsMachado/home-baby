        ...
        <section class="navbar">
            ...
            <div class="navLinks">
                <ul>
                    ...
                    <li><a href="baby.php" class="text-decoration-none">Baby</a></li>
                    <li><a href="aboutUs.php" class="text-decoration-none">About Us</a></li>
                    <li><a href="brands.php" class="text-decoration-none">Brands</a></li>
