...
<section id="home" class="p-5 d-flex justify-content-around">
    ...
    <div class="main pt-3 d-flex flex-column">
        ...
        <?php
            ...
            $sql = "SELECT produtos.ID, titulo, preco, marca, img1 FROM produtos LEFT JOIN marcas ON produtos.ID_marca=marcas.marca WHERE ID_categoria=1 AND ID_sub_categoria=2 ORDER BY titulo";
